...
const Brain_circuit = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const iconNode = [
    [
      "path",
      {
  ...
  return `${validate_component(Icon, "Icon").$$render($$result, Object.assign({}, { name: "brain-circuit" }, $$props, { iconNode }), {}, {
    default: () => {
